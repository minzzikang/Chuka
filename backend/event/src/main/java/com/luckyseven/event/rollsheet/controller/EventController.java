...
public class EventController {
    ...
    //FIXME: @RequestBody -> @RequestPart 수정 필요할 수 있음
    public ResponseEntity<?> createEvent(@RequestPart CreateEventDto createEventDto, @RequestHeader("loggedInUser") String userId) {
        EventDto event = null;
