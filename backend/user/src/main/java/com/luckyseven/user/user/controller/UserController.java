...
public class UserController {
    ...
    public ResponseEntity<MyInfoDto> getMyInfo(@Parameter(hidden = true) @RequestHeader("loggedInUser") String userId) {
    ...
    public ResponseEntity<?> deleteMyId(@Parameter(hidden = true) @RequestHeader("loggedInUser") String userId) {
        // TODO : SINYEONG
